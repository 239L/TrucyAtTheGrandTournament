...
BattleManager.selectNextCommand = function() {
    do { //if(this.actor()){console.log(this.actor().lastBattleSkill()); $gameVariables.setValue(174,this.actor().lastBattleSkill().id);$gameParty.loseItem($dataWeapons[57],1,true);}
