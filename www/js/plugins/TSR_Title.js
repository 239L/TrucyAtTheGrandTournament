...
/*:
 * @plugindesc v2.3.7 Provide multiple options for customizing the Title Screen.
 ...
 * 2024/07/04 Added rotation to Title and custom Label 
 *
 ...
 * @default
 * 
 * @param Title Rotation
 * @parent ---Default Game Title---
 * @desc Rotate the title from its center.
 * -360 till 360 in both sides.
 * @type number
 * @min -360
 * @max 360
 * @default 0
...
//== PARAMETERS ============================================================================
 ...
 TSR.Title.title_rotation      = Number(TSR.Parameters['Title Rotation']); // => Added by ShadowDragon
 ...
 TSR.Title.label_rotation   = Number(TSR.Parameters['Label Rotation']); // => Added by ShadowDragon
 ...
 TSR.Title.titleDegrees = function(degree) { //=> Added by ShadowDragon
    let pi = Math.PI;
...
//== Scene_Title =====================================
  ...
  Scene_Title.prototype.update = function() {
    if (!Graphics.isVideoPlaying()) {
       if (!this._sceneStarted) {
         ...
         //TSR.Title.autoIntro ? Graphics.setVideoVolume(0) : Graphics.setVideoVolume(1)
  ...
  Scene_Title.prototype.drawGameTitle = function(sprite) {
    ...
    this._gameTitleSprite.rotation = TSR.Title.titleDegrees(parseInt(TSR.Title.title_rotation)); // => Added by ShadowDragon
    this._gameTitleSprite.pivot.set(x / 2, y / 2); // => Added by ShadowDragon
  };
  ...
  Scene_Title.prototype.drawTitleLabel = function(sprite) {
    ...
    this._titleLabelSprite.rotation = TSR.Title.titleDegrees(parseInt(TSR.Title.label_rotation)); // => Added by ShadowDragon
    this._titleLabelSprite.pivot.set(x / 2, y / 2);; // => Added by ShadowDragon
