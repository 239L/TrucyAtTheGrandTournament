...
/*:
 * @plugindesc (v1.4) O plugin adiciona uma cena de galeria de imagens.
 * @author Moghunter
 *
...
Window_PictureList.prototype.processOk = function() {
	...
	$gameSwitches.setValue(307,true);
};
...
Scene_Picture_Gallery.prototype.refresh_data = function() {
	...
	$gameVariables.setValue(159,this._playing_index);
};
...
Scene_Picture_Gallery.prototype.set_FullMode = function() {
	...
	$gameTemp.reserveCommonEvent(250);
};
